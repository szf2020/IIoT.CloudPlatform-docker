...
namespace IIoT.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260327081341_Remove_DeviceCode")]
    partial class Remove_DeviceCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IIoT.Core.Employee.Aggregates.Employees.EmployeeProcessAccess", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uuid")
                        .HasColumnName("employee_id");
                    ...
                    b.ToTable("employee_process_accesses", (string)null);
                });
            ...
            modelBuilder.Entity("IIoT.Core.Production.Aggregates.PassStations.PassDataInjection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<decimal>("InjectionVolume")
                        .HasColumnType("numeric(10,4)")
                        .HasColumnName("injection_volume");

                    b.Property<DateTime>("PostInjectionTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("post_injection_time");

                    b.Property<decimal>("PostInjectionWeight")
                        .HasColumnType("numeric(10,4)")
                        .HasColumnName("post_injection_weight");

                    b.Property<DateTime>("PreInjectionTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pre_injection_time");

                    b.Property<decimal>("PreInjectionWeight")
                        .HasColumnType("numeric(10,4)")
                    ...
                    b.HasIndex("DeviceId", "CompletedTime")
                        .HasDatabaseName("ix_pass_data_injection_device_time");

                    b.ToTable("pass_data_injection", (string)null);
                });
